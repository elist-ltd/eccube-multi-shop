...
class PluginManager extends AbstractPluginManager
{
     ...
     * ショップ用権限の名称
     */
    public const AUTHORITY_NAME = 'ショップ（ショッピングモールプラグイン用）';

    /**
     * 作成したショップ用権限のエンティティ保存パス
     */
    public const SHOP_AUTHORITY_XML_PATH = __DIR__.DIRECTORY_SEPARATOR.'shop_authority.xml';

    /**
     * ショップ用権限の拒否URL一覧
     * /setting/shop（基本設定）は ShoppingMallEvent.php onKernelResponse で拒否
     */
    public const DENY_URLS = [
        '/product/category',
        '/product/tag',
